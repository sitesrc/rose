...
padding-right:$(sidebar.width)
    ...
    <script async='async' src='https://cdn.bootcdn.net/ajax/libs/clipboard.js/2.0.4/clipboard.min.js'/>
  </head>
            ...
            <div class='main_header_elements container'>
              ...
              <div class='blog-name'>
                <b:section id='header' name='Header' showaddelement='false'>
                  <b:widget id='Header1' locked='true' title='rose total (標題)' type='Header' visible='true'>
                    <b:widget-settings>
            ...
            <b:include name='super.title'/>
              ...
              <b:if cond='data:view.isLayoutMode or data:widgets any (w =&gt; w.sectionId == &quot;subscription&quot;)'>
                <section class='subscribe-section-container'>
                  <button class='flat-button subscribe-button'><b:eval expr='data:messages.subscribe'/></button>
              ...
              <b:if cond='data:view.isLayoutMode or data:widgets any (w =&gt; w.sectionId == &quot;search_top&quot;)'>
                <div class='search'>
                  ...
                  <b:section id='search_top' name='Search (Top)' showaddelement='false'>
                    <b:widget id='BlogSearch1' locked='true' title='搜尋此網誌' type='BlogSearch' visible='true'>
          ...
          <nav role='navigation'>
            <b:section class='centered-top-secondline' id='page_list_top' name='Page List (Top)' showaddelement='false'>
              <b:widget id='PageList1' locked='true' title='' type='PageList' visible='false'>
                <b:widget-settings>
                  <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'http://www.rose2.xyz/', 'title': '\u9996\u9801', 'position': 0}}]]></b:widget-setting>
              ...
              <div class='centered'>
                <main class='centered-bottom' id='main' role='main' tabindex='-1'>
                  ...
                  <b:section class='main' id='page_body' name='Page Body' showaddelement='false'>
                    <b:widget cond='data:view.isHomepage' id='FeaturedPost1' locked='true' title='' type='FeaturedPost' version='2' visible='false'>
                      <b:widget-settings>
 ...
 &quot;publisher&quot;: {
      ...
      <article class='post' role='article'>
        ...
        <aside class='sidebar-container sidebar-invisible' role='complementary'>
          ...
          <b:section class='sidebar' id='sidebar' name='Sidebar' preferred='yes'>
            <b:widget id='Profile1' locked='false' title='關於我' type='Profile' visible='false'>
              <b:widget-settings>
    ...
    <b:loop values='data:posts' var='post'>
      <li>
        <a expr:href='data:post.url'><data:post.title/></a>
            ...
            <b:widget id='Label1' locked='false' title='標籤' type='Label' visible='true'>
              <b:widget-settings>
    ...
    <b:else/>
      <b:include name='defaultAdUnit'/>
          ...
          <b:with value='&quot;/* Done in css. */&quot;' var='style'>
            ...
            <b:widget id='Label2' locked='false' title='Categories' type='Label' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
                <b:widget-setting name='display'>LIST</b:widget-setting>
                <b:widget-setting name='selectedLabelsList'>Beauty,Business,Fashion,Food,Learn,Music,Nature,People</b:widget-setting>
  ...
  <div class='widget-content'>
    ...
    <b:include cond='data:this.display == &quot;cloud&quot;' name='cloud'/>
          ...
          <b:include data='{                               buttonClass: &quot;flat-button&quot;,                               items: data:this.labels,                               itemSet: &quot;labels&quot;,                               itemsMarkup: &quot;super.list&quot;                             }' name='extendableItems'/>
            ...
            <b:widget id='Label4' locked='false' title='Categories' type='Label' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
                <b:widget-setting name='display'>LIST</b:widget-setting>
                <b:widget-setting name='selectedLabelsList'>Beauty,Business,Fashion,Food,Learn,Music,Nature,People</b:widget-setting>
  ...
  <div class='widget-content'>
    ...
    <b:include cond='data:this.display == &quot;cloud&quot;' name='cloud'/>
          ...
          <b:include data='{                               buttonClass: &quot;flat-button&quot;,                               items: data:this.labels,                               itemSet: &quot;labels&quot;,                               itemsMarkup: &quot;super.list&quot;                             }' name='extendableItems'/>
            ...
            <b:widget id='Label5' locked='false' title='Categories' type='Label' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
                <b:widget-setting name='display'>LIST</b:widget-setting>
                <b:widget-setting name='selectedLabelsList'>Beauty,Business,Fashion,Food,Learn,Music,Nature,People</b:widget-setting>
  ...
  <div class='widget-content'>
    ...
    <script async='async' src='https://cdn.jsdelivr.net/gh/sitesrc/rose/js/2243502101-rockpool_compiled.js'/>
  </body>
</html>